    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profession', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='warriors.profession', verbose_name='Профессия')),
                ('skill', models.ManyToManyField(related_name='warrior_skils', through='warriors.SkillOfWarrior', to='warriors.Skill', verbose_name='Умения')),
            ],
        ),
        migrations.AddField(
