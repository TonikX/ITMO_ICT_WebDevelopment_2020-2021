  ...
  <v-app>
    ...
    >
      <div class="d-flex align-center">
        <h1 class="headline">College</h1>
        <v-col v-if='isAuth'><a @click="logout" style="color: white; text-decoration: underline">LogOut</a></v-col>
        <v-col v-if="!isAuth"><router-link to="/signin" style="color: white">SignIn</router-link></v-col>
        <v-col v-if="!isAuth"><router-link to="/signup" style="color: white">SignUp</router-link></v-col>
      </div>
    </v-app-bar>
