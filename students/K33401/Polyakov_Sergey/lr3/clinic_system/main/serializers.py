...
class DoctorFullSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Doctor
        fields = ['id', 'first_name', 'middle_name', 'last_name', 'specialty', 'education', 'date_of_birth', 'start_work_date', 'finish_work_date', 'contract_number']
...
class AppointmentFullSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Appointment
        fields = ['id', 'doctor', 'cabinet', 'patient', 'finish_time', 'start_time', 'type', 'diagnosis', 'health_status', 'recommendations', 'payed', 'form_of_payment']
