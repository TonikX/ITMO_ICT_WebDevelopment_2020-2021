...
class Warrior(models.Model):
    ...
    skills = models.ManyToManyField('Skill', verbose_name='Умения', through='SkillOfWarrior', related_name='warrior_skills')
...
class SkillOfWarrior(models.Model):
    ...
    def __str__(self):
        return f'{self.warrior}\'s {self.skill} ({self.level})'
