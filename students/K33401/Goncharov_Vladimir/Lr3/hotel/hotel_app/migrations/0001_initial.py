# Generated by Django 3.1.2 on 2020-12-03 02:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='guest', to='hotel_app.room')),
            ],
        ),
        migrations.AddField(
            model_name='cleaning',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cleaning1', to='hotel_app.room'),
        ),
        migrations.AddField(
            model_name='cleaning',
            name='staff',
