...
from .forms import CommentForm, CustomUserCreationForm, CustomRacerCreationForm, RaceEditRegistrationForm, RaceRegistrationForm
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_authenticated:
            if self.request.user.user_type==1:
                ...
                context['comment_form'] = CommentForm(self.request.POST, commentator=commentator, race=context['object'])
...
def race_register_add(request, race_id):
    ...
    return render(request, 'main/race_registration.html', {'form': f})
...
def race_register_edit(request, race_id):
    ...
    return render(request, 'main/race_registration_edit.html', {'form': f})
