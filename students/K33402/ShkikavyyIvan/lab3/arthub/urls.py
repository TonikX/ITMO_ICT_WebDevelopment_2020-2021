...
urlpatterns = [
    path('isRedactor/', IsRedactorAPIView.as_view()),
    ...
    path('authors/creation/<int:authorId>/', CreationListAuthorAPIView.as_view()),
    ...
    path('reviews/creation/<int:creationId>/', ReviewListCreationAPIView.as_view()),
