<template>
  <section>
    ...
    <v-form @submit.prevent="submitUsername" ref="form" class="my-2">
      <v-row>
        <v-col cols="3" class="mx-auto">
          <v-text-field label="Введите своё имя" v-model="username" name="username" placeholder="Иван Иванов" />
        </v-col>
      </v-row>
    </v-form>
    ...
    <v-row>
      <v-col cols="4" class="mx-auto">
        <v-card elevation="2" class="px-2 py-5" color="primary" dark>
