...
class Guest(models.Model):
    ...
    room = models.ForeignKey(
        'Room', on_delete=models.PROTECT, related_name='guests')
...
class Cleaning(models.Model):
    room = models.ForeignKey(
        Room, on_delete=models.CASCADE, related_name='cleaning')
    staff = models.ForeignKey(
        Staff, on_delete=models.CASCADE, related_name='cleaning')
