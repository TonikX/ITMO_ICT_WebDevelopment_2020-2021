    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_cabinet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.cabinet', verbose_name='Номер кабинета')),
            ],
        ),
        migrations.CreateModel(
            name='Meeting',
            fields=[
                ...
                ('id_doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Врач')),
                ('id_patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.patient', verbose_name='Пациент')),
                ('id_price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.price', verbose_name='Услуга')),
            ],
        ),
        migrations.CreateModel(
            name='Medcard',
            fields=[
                ...
                ('id_diagnosis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.diagnosis', verbose_name='Диагноз')),
                ('id_patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.patient', verbose_name='Пациент')),
            ],
        ),
        migrations.AddField(
            model_name='doctor',
            name='cabinet',
            field=models.ManyToManyField(through='hospital.Schedule', to='hospital.Cabinet'),
        ),
        migrations.AddField(
            model_name='doctor',
            name='groups',
