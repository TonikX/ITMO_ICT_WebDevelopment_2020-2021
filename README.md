...
Срок сдачи: **24.09.2020** (включительно). После срока сдачи максимальный бал х0,6.
...
На git должен быть загружен pdf-файл с отчетом, код программамы, **где каждая папка соотвествует часть работы (task_1, task_2...)**. Шабон имени файла: Фамилия_Имя_группа_№лабы
